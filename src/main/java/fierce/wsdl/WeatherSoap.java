...
public interface WeatherSoap {
     ...
     * 
     * @return
     *     returns fierce.wsdl.ArrayOfWeatherDescription
     */
    ...
    @RequestWrapper(localName = "GetWeatherInformation", targetNamespace = "http://ws.cdyne.com/WeatherWS/", className = "fierce.wsdl.GetWeatherInformation")
    @ResponseWrapper(localName = "GetWeatherInformationResponse", targetNamespace = "http://ws.cdyne.com/WeatherWS/", className = "fierce.wsdl.GetWeatherInformationResponse")
     ...
     * @param zip
     * @return
     *     returns fierce.wsdl.ForecastReturn
     */
    ...
    @RequestWrapper(localName = "GetCityForecastByZIP", targetNamespace = "http://ws.cdyne.com/WeatherWS/", className = "fierce.wsdl.GetCityForecastByZIP")
    @ResponseWrapper(localName = "GetCityForecastByZIPResponse", targetNamespace = "http://ws.cdyne.com/WeatherWS/", className = "fierce.wsdl.GetCityForecastByZIPResponse")
     ...
     * @param zip
     * @return
     *     returns fierce.wsdl.WeatherReturn
     */
    ...
    @RequestWrapper(localName = "GetCityWeatherByZIP", targetNamespace = "http://ws.cdyne.com/WeatherWS/", className = "fierce.wsdl.GetCityWeatherByZIP")
    @ResponseWrapper(localName = "GetCityWeatherByZIPResponse", targetNamespace = "http://ws.cdyne.com/WeatherWS/", className = "fierce.wsdl.GetCityWeatherByZIPResponse")
